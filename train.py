...
def train_model(config):
    ...
    # Iterates over epochs. Within each epoch, iterates over batches in the training dataloader. Performs forward pass through the encoder, decoder, and projection layer. Computes loss and performs backpropagation. Logs loss using Tensorboard. Runs validation at the end of each epoch. Saves model weights at the end of each epoch.
